...
def getOrderDetail(orderId):
    ...
    if r.status_code == 200:
        try:
            soup = BeautifulSoup(r.content, 'html.parser') #windows读取格式‘lxml',soup = BeautifulSoup(r.content, 'lxml')
...
def run_dingdan_tj():
    ...
    '''
    taskid = 42340817
    filename11 = '2022-06-17-00-00-00-TO-2022-06-17-23-59-59--10507442--42340817.csv'
    df = pd.read_csv('./downloads/{}/{}'.format(taskid,
                     filename11), encoding='gbk')
